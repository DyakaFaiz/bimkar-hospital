...
class MemeriksaController extends Controller
{
    ...
    { 
        // $janjiPeriksa = JanjiPeriksa::select([
        //     'periksas.id AS idPeriksa',
        //     'periksas.tgl_periksa AS tglPeriksa',
        //     'periksas.catatan',
        // ])
        // ->leftJoin('periksas', 'periksas.id_janji_periksa', 'janji_periksas.id')
        // ->where('janji_periksas.id', $id);
    ...
    { 
        ...
        foreach ($request->obat as $idObat) {
            DetailPeriksa::create([
                ...
                'id_obat' => $idObat, // satu ID per baris
            ]);
        }
